...
The first concrete provider implemented on top of the foundation is the **Git Provider**.
...
└── observation/
    ...
    │   │
    │   └── git/
    │       ├── __init__.py         # Git provider package
...
The Git Provider is the first concrete example of this architecture.
...
The Git Provider is the first completed provider milestone.
...
The Git Provider is therefore the first concrete provider implementation built on top of the Observation Foundation.
